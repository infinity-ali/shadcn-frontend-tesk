...
const AuditLog = () => {
  ...
  return (
    <main className="flex-1">
      ...
      <div className="mt-8 rounded-lg bg-white shadow-sm border border-gray-200">
        <div className="mb-6 grid grid-cols-3 gap-10 border-b pb-4 px-8 py-4">
...
export default function Component() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: "Audit log",
      component: AuditLog,
      state: useState({ filters: { date: "all", user: "all", event: "all" } }),
    },
  ];
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-5xl h-[80vh] m-0 p-0 overflow-hidden">
        <div className="flex gap-6 h-full">
          <ScrollArea className="w-56 border-r pr-4 bg-gray-300 p-4">
            {menuItems.map(
